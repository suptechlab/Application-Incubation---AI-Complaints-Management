...
const RaisedComplaintModal = ({ handleShow, selectedRow, handleClose }) => {
    ...
    const handleSubmit = async (values, actions) => {
        ...
        formData.append('specificPetition', values.specificPetition);
        formData.append('precedents', values.precedents);
        appendFilesToFormData(formData, files);
        setLoading(true);
        const result = await dispatch(fileRaiseComplaintForm(formData));
