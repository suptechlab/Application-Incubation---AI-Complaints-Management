...
public class UserClaimTicketService {
    ...
    public ClaimTicketWorkFlowDTO fileComplaint(ComplaintRequest complaintRequest, RequestInfo requestInfo) {
        ...
        complaintTicket.setPrecedents(originalClaimTicket.getPrecedents());
        complaintTicket.setSpecificPetition(originalClaimTicket.getSpecificPetition());
        ...
        complaintTicket.setSecondInstanceComment(originalClaimTicket.getSecondInstanceComment());
        complaintTicket.setPreviousTicketId(originalClaimId);
        complaintTicket.setComplaintPrecedents(complaintRequest.getPrecedents());
        complaintTicket.setComplaintSpecificPetition(complaintRequest.getSpecificPetition());
