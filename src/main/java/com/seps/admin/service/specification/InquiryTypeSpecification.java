...
public class InquiryTypeSpecification {
    private InquiryTypeSpecification() {
    }

    public static Specification<InquiryTypeEntity> byFilter(String search, Boolean status) {
