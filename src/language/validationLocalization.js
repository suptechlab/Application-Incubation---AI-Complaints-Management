export const messages = {
  en: {
    ...
    phoneNumberInvalid: 'Mobile number must be exactly 9 digits',
    ...
    customterTypeRequired: "Se requiere tipo de usuario.",
    entityNameRequired: "Entity Name is required.",
    claimSubTypeRequired: "Claim Sub Type is required.",
    invalidPrecedents: "Precedents must not exceed 5000 characters.",
    precedentsRequired: "Precedents is required.",
    invalidSpecialPetition: "La petición concreta no debe exceder los 5000 caracteres.",
    specialPetitionRequired: "Se requiere petición concreta.",
  ...
  es: {
    ...
    phoneNumberInvalid: 'El número de celular debe tener exactamente 9 dígitos" (Considerando que se pone el prefijo del país en vez del 0)',
    phoneNumberRequired: '¡Se requiere número de teléfono con código de país',
    countryCodeRequired: '!Se requiere código del país',
    countryCodeInvalid: 'Código de país inválido',
    ...
    maximumLimit100: "El límite máximo es 100 caracteres",
    ...
    passwordMax16: "El límite máximo es 16 caracteres",
    ...
    //create claim
    genderRequired: "Se requiere sexo.",
    ...
    invalidPrecedents: "Los antecedentes no deben exceder los 5000 caracteres.",
