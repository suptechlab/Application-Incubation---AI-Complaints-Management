...
RUN pip install "packaging==20.0" "dask==2022.10.2" "faiss-cpu==1.8.0.post1" "marshmallow==3.22.0" "matplotlib==3.5.3" "rasa==3.6.20" "openai==1.54.1" "python-dotenv==1.0.1" "chardet==5.2.0" --no-cache-dir
RUN pip install --upgrade openai --no-cache-dir
...
CMD rasa run --enable-api --cors "*" \
    --model /app/models/20250407-160456-local-subscriber.tar.gz \
    --credentials /app/credentials.yml --debug & \
    rasa run actions