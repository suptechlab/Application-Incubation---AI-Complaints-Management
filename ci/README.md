...
### Upload artefact
helm nexus-push . fr-seps-base-web-1.0.0-snapshot.tgz  -u <myUser > -p <myPassword>
Ó
helm nexus-push seps-helm fr-seps-base-web-1.0.0-snapshot.tgz  -u <myUser > -p <myPassword>  
Ó
